# AeroStrazh AI - Автоматизация паспортного контроля
...
![Аналоговая диаграмма классов](/image2)
...
![Результаты распознавания](/image5)
